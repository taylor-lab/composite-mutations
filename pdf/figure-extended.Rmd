...
#info_all$dat_all$prop <- info_all$dat_all$x / N
#info_all$n_compounds <- info_all$obs_all * Nmut
#info_all$obs_all <- info_all$n_compounds / N
...
names(cols) <- c('patients','compound')
