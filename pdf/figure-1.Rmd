...
## use results from the improved permutation test
#dat <- fread(here::here('data/tmb_enrichment_permutation_test.txt'))
#setnames(dat,'p.value','p')
#setnames(dat,'tmb','burden')
#dat$nlog10p <- -log10(dat$p)
#dat$nlog10p[dat$nlog10p>4] <- 4
