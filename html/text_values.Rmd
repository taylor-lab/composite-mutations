...
## phasing for compound 1: R280K+E285K (mm: R277K+E282K)
d <- fread(here('data/data_mutations_phased.txt.gz'))
d <- d[Hugo_Symbol=='TP53' & exclude==F,]
x[,c('Tumor_Sample_Barcode','HGVSp_Short.1','HGVSp_Short.2','phase','metamaintype','ccf_Mcopies.1','ccf_Mcopies.2'),with=F]

## phasing for compound 2: R280T+E287D (mm: R277T+E284D)
x <- d[HGVSp_Short.2=='p.R280T' & HGVSp_Short.1=='p.E287D']
x[,c('Tumor_Sample_Barcode','HGVSp_Short.1','HGVSp_Short.2','phase','metamaintype','ccf_Mcopies.1','ccf_Mcopies.2'),with=F]
...
tmp <- d_phased[Hugo_Symbol=='TP53' & phase=='cis']
tmp[Protein_position.1=='287/393',c('Tumor_Sample_Barcode','HGVSp_Short.1','HGVSp_Short.2'),with=F]
tmp[HGVSp_Short.1,c('Tumor_Sample_Barcode','HGVSp_Short.1','HGVSp_Short.2'),with=F]
